...
public final class LogQuery {
    ...
    public static void main(String[] args) {
        ...
        SparkSession spark = SparkSession.builder().appName("JavaLogQuery").master("local[*]").getOrCreate();
